...
Description: 
   ...
   Polar decomposition implementation by Ken Shoemake
   <shoemake@graphics.cis.upenn.edu>. 
   From the Graphics Gems IV archive.
...
double norm_inf(HMatrix M) {return mat_norm(M, 0);}
double norm_one(HMatrix M) {return mat_norm(M, 1);}
