...
static const double kHighlightedSize = 25;
static const double kSelectedSize = 20;
...
void PointManager::setup()
{
    ...
    for (int i = 0; i < kNumPoints; i++)
    {
        ...
        point.m_color[0] = ((HDdouble) rand() / RAND_MAX);
        point.m_color[1] = ((HDdouble) rand() / RAND_MAX);
        point.m_color[2] = ((HDdouble) rand() / RAND_MAX);
...
void PointManager::drawPoints()
{
    ...
    for (int i = 0; i < nPoints; i++)
    {
        ...
        else
        {
            ...
            glColor3dv(m_pointList[i].m_color);
        }
