...
Description:
  ...
  Creates several points that the device can snap to using point view
  apparent snapping.
...
/******************************************************************************
 Initialize GLUT and the kick off the main loop
******************************************************************************/
int main(int argc, char *argv[])
{
    ...
    glutCreateWindow("Point Snapping Example");
...
/******************************************************************************
 ...
 graphics rate processing, like updating the graphic state of the haptic manager
******************************************************************************/
void glutDisplay()
{    
